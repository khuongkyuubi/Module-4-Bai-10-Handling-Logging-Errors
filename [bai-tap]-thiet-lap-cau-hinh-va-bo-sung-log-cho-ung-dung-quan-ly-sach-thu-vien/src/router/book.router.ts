...
bookRoutes.post('/create', upload.none(), asyncWrapper(async (req, res, next) => {
    // try {
...
bookRoutes.post('/update/:id', upload.none(), async (req, res, next) => {
    try {
...
bookRoutes.get('/list', async (req, res, next) => {
    try {
        let query = {};
